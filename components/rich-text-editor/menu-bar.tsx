...
import { Bold, Heading1, Heading2, Heading3, Italic, ListIcon, ListOrdered, Redo, Strikethrough, TextAlignCenter, TextAlignEnd, TextAlignJustify, TextAlignStart, Undo } from "lucide-react"
...
export function MenuBar({editor} : iAppProps){
    ...
    return (
        <div className="border border-input rounded-t-lg p-2 bg-card flex flex flex-wrap gap-1 items-center">
            <TooltipProvider>
